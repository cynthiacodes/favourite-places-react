export const myEntries = [
...

  {
    ...
    text: "As the golden sun begins to set over the vast plains of Maasai Mara, casting a warm glow across the landscape, you find yourself in awe of the breathtaking beauty that surrounds you.",
  },
  {
    ...
    text: "Lyme Park is an enchanting estate that seamlessly combines stunning landscapes, grand architecture, and a rich history.",
  },
  {
    ...
    text: 'Suzhou, often referred to as the "Venice of China," is a city renowned for its enchanting waterways, classical gardens, and rich cultural heritage.',
  },
];
